...
pub const _NPKT_PER_CORR: usize = (1 << 16) / 2; // 1/(1/2/480e6*1024)
pub const _NFRAME_PER_CORR: usize = _NPKT_PER_CORR * NFRAME_PER_PKT;
pub const NCH_TOTAL: usize = 512;
pub const NBEAMS: usize = 2;
pub const NPORTS_TOTAL: usize = 16;
pub const NPORTS_PER_STATION: usize = 128;
